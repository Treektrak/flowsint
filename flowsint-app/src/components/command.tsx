  ...
  return (
    <>
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        <CommandInput
          placeholder={t('misc.commandPlaceholder')}
          value={searchQuery}
          ...
          {isLoading ? (
            ...
            <>
              {filteredData.investigations.length === 0 && filteredData.analyses.length === 0 ? (
                <CommandEmpty>{t('misc.noResultsFound')}</CommandEmpty>
              ) : (
                <>
                  {filteredData.investigations.length > 0 && (
                    <CommandGroup heading={t('misc.investigations')}>
                  ...
                  <CommandSeparator />
                  <CommandGroup heading={t('misc.quickActions')}>
                    <CommandItem
                      onSelect={() => {
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <Fingerprint className="h-4 w-4" />
                        <span>{t('misc.allInvestigations')}</span>
                      </div>
                    </CommandItem>
                    <CommandItem
                      onSelect={() => {
